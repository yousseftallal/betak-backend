...
import { Search, Filter, X, Calendar, Shield, Crown } from 'lucide-react';
import { useSearchParams } from 'react-router-dom';

export default function UserFilters({ onFilterChange, onReset }) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <select
                    ...
                    onChange={(e) => {
                        ...
                        handleParamChange('verified', e.target.value);
                    }}
                >
